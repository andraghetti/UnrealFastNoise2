...
{
public:
    void SetSource(SmartNodeArg<T> gen)
    {
    ...
    void SetGain(SmartNodeArg<> gen)
    {
        mGain = 1.0f;
        this->SetSourceMemberVariable(mGain, gen);
        CalculateFractalBounding();
    }
    void SetWeightedStrength(float value)
    {
        mWeightedStrength = value;
    }
    void SetWeightedStrength(SmartNodeArg<> gen)
    {
        this->SetSourceMemberVariable(mWeightedStrength, gen);
    }
...
public:
    ...
    void SetPingPongStrength(float value)
    {
        mPingPongStrength = value;
    }
    void SetPingPongStrength(SmartNodeArg<> gen)
    {
        this->SetSourceMemberVariable(mPingPongStrength, gen);
    }
...
struct MetadataT<FractalPingPong> : MetadataT<Fractal<>>
{
    ...
    MetadataT()
    {
        this->AddHybridSource(
            "Ping Pong Strength", 2.0f, &FractalPingPong::SetPingPongStrength, &FractalPingPong::SetPingPongStrength);
    }
};
#endif
}    // namespace FastNoise
